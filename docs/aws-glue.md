...
The following instructions are for running PySpark application defined by [src/spark/credit_card_balance_dq.py](/src/spark/credit_card_balance_dq.py) for reading the Parquet file generated by [Federal Reserve Data Analytics](#federal-reserve-data-analytics).
